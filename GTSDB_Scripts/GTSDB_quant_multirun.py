...
parser.add_argument("--load_weights", type=bool, default=False, help="Load model weights (default: False)")
...
weight_quantizer_init = lq.quantizers.DoReFa(k_bit=5, mode="weights")
activation_quantizer_init = lq.quantizers.DoReFa(k_bit=5)
...
class SaveBestAccuracyCallback(callbacks.Callback):
    def __init__(self, filepath, model_filepath, total_epochs, run_number):
        super().__init__()
